...
def add_logo():
    image_url = "https://github.com/Sejal00067/ODIN-MAIN/blob/main/src/Background.jpg"
    st.markdown(
        f"""
        <style>
...
<style>
body {
    background-image: url("https://github.com/Sejal00067/ODIN-MAIN/blob/main/src/Background.jpg");
                background-repeat: no-repeat;
...
def main():
    ...
    if choice == "Home":
        st.subheader("Attendance Management With Signature Recognition")
